...
async function UpdateAccount(selectedProfile, uploadFile) {
  ...
  //     await axios.put(`http://localhost:8080/profile/update/${id}`, formData, {
  ...
  //       // pwd: selectedProfile.pwd
  //       connection: selectedProfile.connection,
  //       birthday: selectedProfile.birthday,
  //       profileImage: `src/frontend/applejun/public/profile-image/${uploadFile.name}`,
  //     };
  //     await axios.put(
